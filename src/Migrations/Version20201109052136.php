 ...
 */
final class Version20201109052136 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agenda (id INT AUTO_INCREMENT NOT NULL, cuenta_id INT DEFAULT NULL, gestionar_id INT DEFAULT NULL, agendador_id INT DEFAULT NULL, sucursal_id INT DEFAULT NULL, campania VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, nombre_cliente VARCHAR(255) DEFAULT NULL, email_cliente VARCHAR(255) DEFAULT NULL, telefono_cliente VARCHAR(255) DEFAULT NULL, ciudad_cliente VARCHAR(255) DEFAULT NULL, fecha_carga DATETIME DEFAULT NULL, fecha_asignado DATETIME DEFAULT NULL, INDEX IDX_2CEDC8779AEFF118 (cuenta_id), INDEX IDX_2CEDC877CA6D16AE (gestionar_id), INDEX IDX_2CEDC877BBF3C044 (agendador_id), INDEX IDX_2CEDC877279A5D5E (sucursal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
