 ...
 */
final class Version20201104030540 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu ADD menu_cabezera_id INT DEFAULT NULL, CHANGE depende_de_id depende_de_id INT DEFAULT NULL, CHANGE modulo_id modulo_id INT DEFAULT NULL, CHANGE icono icono VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE menu ADD CONSTRAINT FK_7D053A93975F194D FOREIGN KEY (menu_cabezera_id) REFERENCES menu_cabezera (id)');
        $this->addSql('CREATE INDEX IDX_7D053A93975F194D ON menu (menu_cabezera_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_7D053A93975F194D ON menu');
        $this->addSql('ALTER TABLE menu DROP menu_cabezera_id, CHANGE depende_de_id depende_de_id INT DEFAULT NULL, CHANGE modulo_id modulo_id INT DEFAULT NULL, CHANGE icono icono VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
