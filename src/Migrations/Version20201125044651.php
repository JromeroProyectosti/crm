 ...
 */
final class Version20201125044651 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE importacion ADD cuenta_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE importacion ADD CONSTRAINT FK_F483A40E9AEFF118 FOREIGN KEY (cuenta_id) REFERENCES cuenta (id)');
        $this->addSql('CREATE INDEX IDX_F483A40E9AEFF118 ON importacion (cuenta_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_F483A40E9AEFF118 ON importacion');
        $this->addSql('ALTER TABLE importacion DROP cuenta_id');
        $this->addSql('ALTER TABLE juzgado CHANGE empresa_id empresa_id INT DEFAULT NULL');
