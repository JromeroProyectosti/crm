 ...
 */
final class Version20201118124039 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE usuario_usuariocategoria ADD agenda_id INT DEFAULT NULL, CHANGE cuenta_id cuenta_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_892F60F1EA67784A ON usuario_usuariocategoria (agenda_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_892F60F1EA67784A ON usuario_usuariocategoria');
        $this->addSql('ALTER TABLE usuario_usuariocategoria DROP agenda_id, CHANGE cuenta_id cuenta_id INT DEFAULT NULL');
