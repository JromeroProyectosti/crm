 ...
 */
final class Version20210219025604 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuota CHANGE usuario_anulacion_id usuario_anulacion_id INT DEFAULT NULL, CHANGE pagado pagado INT DEFAULT NULL, CHANGE anular anular TINYINT(1) DEFAULT NULL, CHANGE fecha_anulacion fecha_anulacion DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE pago ADD usuario_anulacion_id INT DEFAULT NULL, ADD anulado TINYINT(1) DEFAULT NULL, ADD fecha_anulacion DATETIME DEFAULT NULL, CHANGE fecha_ingreso fecha_ingreso DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE pago ADD CONSTRAINT FK_F4DF5F3EBAF036CE FOREIGN KEY (usuario_anulacion_id) REFERENCES usuario (id)');
        $this->addSql('CREATE INDEX IDX_F4DF5F3EBAF036CE ON pago (usuario_anulacion_id)');
        ...
        $this->addSql('ALTER TABLE pago_tipo CHANGE empresa_id empresa_id INT DEFAULT NULL, CHANGE orden orden INT DEFAULT NULL, CHANGE estado estado TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_F4DF5F3EBAF036CE ON pago');
        $this->addSql('ALTER TABLE pago DROP usuario_anulacion_id, DROP anulado, DROP fecha_anulacion, CHANGE fecha_ingreso fecha_ingreso DATE DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE pago_canal CHANGE empresa_id empresa_id INT DEFAULT NULL, CHANGE estado estado TINYINT(1) DEFAULT \'NULL\', CHANGE orden orden INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pago_tipo CHANGE empresa_id empresa_id INT DEFAULT NULL, CHANGE orden orden INT DEFAULT NULL, CHANGE estado estado TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE pais CHANGE empresa_id empresa_id INT DEFAULT NULL, CHANGE orden orden INT DEFAULT NULL');
        $this->addSql('ALTER TABLE privilegio CHANGE modulo_per_id modulo_per_id INT DEFAULT NULL');
