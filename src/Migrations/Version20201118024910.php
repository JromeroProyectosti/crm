 ...
 */
final class Version20201118024910 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE usuario_usuariocategoria (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, categoria_id INT NOT NULL, cuenta_id INT DEFAULT NULL, INDEX IDX_892F60F1DB38439E (usuario_id), INDEX IDX_892F60F13397707A (categoria_id), INDEX IDX_892F60F19AEFF118 (cuenta_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE usuario_usuariocategoria ADD CONSTRAINT FK_892F60F13397707A FOREIGN KEY (categoria_id) REFERENCES usuario_categoria (id)');
