 ...
 */
final class Version20201101142506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu ADD icono VARCHAR(255) DEFAULT NULL, CHANGE modulo_id modulo_id INT DEFAULT NULL, CHANGE depende_de_id depende_de_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu DROP icono, CHANGE modulo_id modulo_id INT DEFAULT NULL, CHANGE depende_de_id depende_de_id INT DEFAULT NULL');
