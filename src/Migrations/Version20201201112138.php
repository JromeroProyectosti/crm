 ...
 */
final class Version20201201112138 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agenda_status CHANGE orden orden INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE contrato ADD vehiculo_id INT DEFAULT NULL, ADD vivienda_id INT DEFAULT NULL, CHANGE estado_civil_id estado_civil_id INT DEFAULT NULL, CHANGE situacion_laboral_id situacion_laboral_id INT DEFAULT NULL, CHANGE estrategia_juridica_id estrategia_juridica_id INT DEFAULT NULL, CHANGE escritura_id escritura_id INT DEFAULT NULL, CHANGE agenda_id agenda_id INT DEFAULT NULL, CHANGE sucursal_id sucursal_id INT DEFAULT NULL, CHANGE tramitador_id tramitador_id INT DEFAULT NULL, CHANGE cliente_id cliente_id INT DEFAULT NULL, CHANGE pais_id pais_id INT DEFAULT NULL, CHANGE ciudad ciudad VARCHAR(255) DEFAULT NULL, CHANGE titulo_contrato titulo_contrato VARCHAR(255) DEFAULT NULL, CHANGE monto_nivel_deuda monto_nivel_deuda NUMERIC(10, 0) DEFAULT NULL, CHANGE monto_contrato monto_contrato NUMERIC(10, 0) DEFAULT NULL, CHANGE cuotas cuotas INT DEFAULT NULL, CHANGE valor_cuota valor_cuota NUMERIC(10, 0) DEFAULT NULL, CHANGE interes interes NUMERIC(5, 2) DEFAULT NULL, CHANGE dia_pago dia_pago INT DEFAULT NULL, CHANGE fecha_creacion fecha_creacion DATETIME DEFAULT NULL, CHANGE clave_unica clave_unica VARCHAR(255) DEFAULT NULL, CHANGE telefono_recado telefono_recado VARCHAR(255) DEFAULT NULL, CHANGE fecha_primer_pago fecha_primer_pago DATETIME DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_6669652325F7D575 ON contrato (vehiculo_id)');
        $this->addSql('CREATE INDEX IDX_6669652381A75788 ON contrato (vivienda_id)');
        $this->addSql('ALTER TABLE contrato_rol CHANGE contrato_id contrato_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_6669652325F7D575 ON contrato');
        $this->addSql('DROP INDEX IDX_6669652381A75788 ON contrato');
        $this->addSql('ALTER TABLE contrato DROP vehiculo_id, DROP vivienda_id, CHANGE estado_civil_id estado_civil_id INT DEFAULT NULL, CHANGE situacion_laboral_id situacion_laboral_id INT DEFAULT NULL, CHANGE estrategia_juridica_id estrategia_juridica_id INT DEFAULT NULL, CHANGE escritura_id escritura_id INT DEFAULT NULL, CHANGE agenda_id agenda_id INT DEFAULT NULL, CHANGE sucursal_id sucursal_id INT DEFAULT NULL, CHANGE tramitador_id tramitador_id INT DEFAULT NULL, CHANGE cliente_id cliente_id INT DEFAULT NULL, CHANGE pais_id pais_id INT DEFAULT NULL, CHANGE ciudad ciudad VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE titulo_contrato titulo_contrato VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE monto_nivel_deuda monto_nivel_deuda NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE monto_contrato monto_contrato NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE cuotas cuotas INT DEFAULT NULL, CHANGE valor_cuota valor_cuota NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE interes interes NUMERIC(5, 2) DEFAULT \'NULL\', CHANGE dia_pago dia_pago INT DEFAULT NULL, CHANGE fecha_creacion fecha_creacion DATETIME DEFAULT \'NULL\', CHANGE clave_unica clave_unica VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE telefono_recado telefono_recado VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE fecha_primer_pago fecha_primer_pago DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE contrato_rol CHANGE contrato_id contrato_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE cuenta CHANGE fecha_ultimamodificacion fecha_ultimamodificacion DATETIME DEFAULT \'NULL\', CHANGE page_id page_id DOUBLE PRECISION DEFAULT \'NULL\'');
