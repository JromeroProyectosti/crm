 ...
 */
final class Version20210128151641 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contrato ADD is_abono TINYINT(1) DEFAULT NULL');
