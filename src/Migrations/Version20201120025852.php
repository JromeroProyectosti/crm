 ...
 */
final class Version20201120025852 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contrato_rol ADD abogado_id INT NOT NULL, CHANGE contrato_id contrato_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE contrato_rol ADD CONSTRAINT FK_AF4B3B55BDBF9863 FOREIGN KEY (abogado_id) REFERENCES usuario (id)');
        $this->addSql('CREATE INDEX IDX_AF4B3B55BDBF9863 ON contrato_rol (abogado_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_AF4B3B55BDBF9863 ON contrato_rol');
        $this->addSql('ALTER TABLE contrato_rol DROP abogado_id, CHANGE contrato_id contrato_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE cuenta CHANGE fecha_ultimamodificacion fecha_ultimamodificacion DATETIME DEFAULT \'NULL\', CHANGE page_id page_id DOUBLE PRECISION DEFAULT \'NULL\'');
