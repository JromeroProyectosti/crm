 ...
 */
final class Version20201101022832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE empresa ADD logo_alt VARCHAR(255) DEFAULT NULL, CHANGE rol rol VARCHAR(255) DEFAULT NULL, CHANGE logo logo VARCHAR(255) DEFAULT NULL, CHANGE fecha_ultimamodificacion fecha_ultimamodificacion DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE menu CHANGE modulo_id modulo_id INT DEFAULT NULL');
