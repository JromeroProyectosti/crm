 ...
 */
final class Version20201125230747 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE importacion ADD usuario_carga_id INT DEFAULT NULL, CHANGE cuenta_id cuenta_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_F483A40E8924462A ON importacion (usuario_carga_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_F483A40E8924462A ON importacion');
        $this->addSql('ALTER TABLE importacion DROP usuario_carga_id, CHANGE cuenta_id cuenta_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE juzgado CHANGE empresa_id empresa_id INT DEFAULT NULL');
