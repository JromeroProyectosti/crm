 ...
 */
final class Version20201126000019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agenda_observacion (id INT AUTO_INCREMENT NOT NULL, agenda_id INT NOT NULL, usuario_registro_id INT NOT NULL, status_id INT DEFAULT NULL, fecha_registro DATETIME NOT NULL, observacion LONGTEXT NOT NULL, INDEX IDX_BB645400EA67784A (agenda_id), INDEX IDX_BB6454001EEFD20 (usuario_registro_id), INDEX IDX_BB6454006BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
