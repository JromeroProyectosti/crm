 ...
 */
final class Version20201106031047 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu CHANGE depende_de_id depende_de_id INT DEFAULT NULL, CHANGE modulo_id modulo_id INT DEFAULT NULL, CHANGE menu_cabezera_id menu_cabezera_id INT DEFAULT NULL, CHANGE icono icono VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE usuario_tipo ADD empresa_id INT DEFAULT NULL, CHANGE menu_cabezera_id menu_cabezera_id INT DEFAULT NULL, CHANGE nombre nombre VARCHAR(20) NOT NULL, CHANGE orden orden INT DEFAULT NULL');
        $this->addSql('ALTER TABLE usuario_tipo ADD CONSTRAINT FK_19576757521E1991 FOREIGN KEY (empresa_id) REFERENCES empresa (id)');
        $this->addSql('CREATE INDEX IDX_19576757521E1991 ON usuario_tipo (empresa_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu CHANGE depende_de_id depende_de_id INT DEFAULT NULL, CHANGE modulo_id modulo_id INT DEFAULT NULL, CHANGE menu_cabezera_id menu_cabezera_id INT DEFAULT NULL, CHANGE icono icono VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE menu_cabezera CHANGE empresa_id empresa_id INT DEFAULT NULL');
        ...
        $this->addSql('DROP INDEX IDX_19576757521E1991 ON usuario_tipo');
        $this->addSql('ALTER TABLE usuario_tipo DROP empresa_id, CHANGE menu_cabezera_id menu_cabezera_id INT DEFAULT NULL, CHANGE nombre nombre VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE orden orden INT DEFAULT NULL');
