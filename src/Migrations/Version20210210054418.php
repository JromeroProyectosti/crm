 ...
 */
final class Version20210210054418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pago (id INT AUTO_INCREMENT NOT NULL, pago_tipo_id INT NOT NULL, pago_canal_id INT NOT NULL, usuario_registro_id INT NOT NULL, monto INT NOT NULL, boleta VARCHAR(255) NOT NULL, observacion LONGTEXT DEFAULT NULL, fecha_pago DATETIME NOT NULL, hora_pago TIME NOT NULL, fecha_registro DATETIME NOT NULL, INDEX IDX_F4DF5F3EC6690F67 (pago_tipo_id), INDEX IDX_F4DF5F3EFF66CCC7 (pago_canal_id), INDEX IDX_F4DF5F3E1EEFD20 (usuario_registro_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pago_tipo (id INT AUTO_INCREMENT NOT NULL, empresa_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, orden INT DEFAULT NULL, estado TINYINT(1) DEFAULT NULL, INDEX IDX_567222FB521E1991 (empresa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
