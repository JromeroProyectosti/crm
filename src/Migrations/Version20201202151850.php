 ...
 */
final class Version20201202151850 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agenda_status ADD icon VARCHAR(255) DEFAULT NULL, ADD color VARCHAR(255) DEFAULT NULL, CHANGE orden orden INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agenda_observacion CHANGE status_id status_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE agenda_status DROP icon, DROP color, CHANGE orden orden INT DEFAULT NULL');
