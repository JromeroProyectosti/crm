 ...
 */
final class Version20201104040111 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE usuario_tipo ADD menu_cabezera_id INT DEFAULT NULL, CHANGE orden orden INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_19576757975F194D ON usuario_tipo (menu_cabezera_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_19576757975F194D ON usuario_tipo');
        $this->addSql('ALTER TABLE usuario_tipo DROP menu_cabezera_id, CHANGE orden orden INT DEFAULT NULL');
