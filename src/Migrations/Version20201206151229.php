 ...
 */
final class Version20201206151229 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE usuario ADD lunes TINYINT(1) DEFAULT NULL, ADD lunes_start TIME DEFAULT NULL, ADD lunes_end TIME DEFAULT NULL, ADD martes TINYINT(1) DEFAULT NULL, ADD martes_start TIME DEFAULT NULL, ADD martes_end TIME DEFAULT NULL, ADD miercoles TINYINT(1) DEFAULT NULL, ADD miercoles_start TIME DEFAULT NULL, ADD miercoles_end TIME DEFAULT NULL, ADD jueves TINYINT(1) DEFAULT NULL, ADD jueves_start TIME DEFAULT NULL, ADD jueves_end TIME DEFAULT NULL, ADD viernes TINYINT(1) DEFAULT NULL, ADD viernes_start TIME DEFAULT NULL, ADD viernes_end TIME DEFAULT NULL, ADD sabado TINYINT(1) DEFAULT NULL, ADD sabado_start TIME DEFAULT NULL, ADD sabado_end TIME DEFAULT NULL, ADD domingo TINYINT(1) DEFAULT NULL, ADD domingo_start TIME DEFAULT NULL, ADD domingo_end TIME DEFAULT NULL, CHANGE categoria_id categoria_id INT DEFAULT NULL, CHANGE status_id status_id INT DEFAULT NULL, CHANGE tipo_documento_id tipo_documento_id INT DEFAULT NULL, CHANGE empresa_actual empresa_actual INT DEFAULT NULL, CHANGE fecha_no_disponible fecha_no_disponible DATETIME DEFAULT NULL, CHANGE whatsapp whatsapp VARCHAR(255) DEFAULT NULL, CHANGE telefono telefono VARCHAR(255) DEFAULT NULL, CHANGE rut rut VARCHAR(255) DEFAULT NULL, CHANGE direccion direccion VARCHAR(255) DEFAULT NULL, CHANGE sexo sexo VARCHAR(255) DEFAULT NULL, CHANGE color color VARCHAR(255) DEFAULT NULL, CHANGE password_ant password_ant VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE situacion_laboral CHANGE empresa_id empresa_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sucursal CHANGE cuenta_id cuenta_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE usuario DROP lunes, DROP lunes_start, DROP lunes_end, DROP martes, DROP martes_start, DROP martes_end, DROP miercoles, DROP miercoles_start, DROP miercoles_end, DROP jueves, DROP jueves_start, DROP jueves_end, DROP viernes, DROP viernes_start, DROP viernes_end, DROP sabado, DROP sabado_start, DROP sabado_end, DROP domingo, DROP domingo_start, DROP domingo_end, CHANGE categoria_id categoria_id INT DEFAULT NULL, CHANGE status_id status_id INT DEFAULT NULL, CHANGE tipo_documento_id tipo_documento_id INT DEFAULT NULL, CHANGE empresa_actual empresa_actual INT DEFAULT NULL, CHANGE fecha_no_disponible fecha_no_disponible DATETIME DEFAULT \'NULL\', CHANGE whatsapp whatsapp VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE telefono telefono VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE rut rut VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE direccion direccion VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE sexo sexo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE color color VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE password_ant password_ant VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE usuario_cuenta CHANGE cuenta_id cuenta_id INT DEFAULT NULL, CHANGE usuario_id usuario_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE usuario_tipo CHANGE menu_cabezera_id menu_cabezera_id INT DEFAULT NULL, CHANGE empresa_id empresa_id INT DEFAULT NULL, CHANGE orden orden INT DEFAULT NULL');
        $this->addSql('ALTER TABLE usuario_usuariocategoria CHANGE cuenta_id cuenta_id INT DEFAULT NULL, CHANGE agenda_id agenda_id INT DEFAULT NULL');
