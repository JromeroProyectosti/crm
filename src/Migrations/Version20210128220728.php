 ...
 */
final class Version20210128220728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuota ADD contrato_id INT NOT NULL, CHANGE usuario_anulacion_id usuario_anulacion_id INT DEFAULT NULL, CHANGE pagado pagado INT DEFAULT NULL, CHANGE anular anular TINYINT(1) DEFAULT NULL, CHANGE fecha_anulacion fecha_anulacion DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE cuota ADD CONSTRAINT FK_763CCB0F70AE7BF1 FOREIGN KEY (contrato_id) REFERENCES contrato (id)');
        $this->addSql('CREATE INDEX IDX_763CCB0F70AE7BF1 ON cuota (contrato_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_763CCB0F70AE7BF1 ON cuota');
        $this->addSql('ALTER TABLE cuota DROP contrato_id, CHANGE usuario_anulacion_id usuario_anulacion_id INT DEFAULT NULL, CHANGE pagado pagado INT DEFAULT NULL, CHANGE anular anular TINYINT(1) DEFAULT \'NULL\', CHANGE fecha_anulacion fecha_anulacion DATETIME DEFAULT \'NULL\'');
