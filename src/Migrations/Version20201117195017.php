 ...
 */
final class Version20201117195017 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contrato_rol (id INT AUTO_INCREMENT NOT NULL, juzgado_id INT NOT NULL, contrato_id INT NOT NULL, nombre_rol VARCHAR(255) NOT NULL, institucion_acreedora VARCHAR(255) NOT NULL, INDEX IDX_AF4B3B55B9A57363 (juzgado_id), INDEX IDX_AF4B3B5570AE7BF1 (contrato_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
